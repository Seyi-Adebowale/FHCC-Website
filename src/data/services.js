...
export const servicesPreview = [
  {
    title: 'Creche',
    description: 'We offer Day Care services for babies, toddlers and young children.',
    image: '/images/removal.ai]_tmp-61af515082bdb.webp',
  },
  {
    title: 'Pre-Nursery',
    description: 'We help kids start identifying surrounding objects, pictures, and begin social interactions with their peer group.',
    image: '/images/SectionBeforeAfterIcon.webp',
  },
  {
    title: 'Nursery & Kindergarten',
    description: 'We lay a solid and sustainable foundation for Primary Level Education.',
    image: '/images/istockphoto-93135471-612x612-removebg-preview.webp',
  },
];
